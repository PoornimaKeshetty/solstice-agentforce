...
class SupervisorAgent(BaseAgent):
    ...
    async def run(self, message):
        ...
        Classify the user message into one of: GREETING, ORDER_STATUS, PRODUCT_SPEC, or UNKNOWN.
        ...
        {
          "intent": "GREETING" | "ORDER_STATUS" | "PRODUCT_SPEC" | "UNKNOWN",
          "confidence": 0.0-1.0,
          "entities": {
        ...
        try:
            ...
            if intent == "GREETING":
                ...
                return {
                    "message": "Hello! I'm your Solstice Assistant. I can help you track your orders, check product specifications, or answer technical questions about our materials. How can I assist you today?",
